...
const Matrix4 Matrix4::Identity(m4IdentRow);
...
{
	memcpy(mat, inMat, 16 * sizeof(float)); // Copies the provided matrix into this object
}
...
Matrix4 Matrix4::CreatePerspective(float left, float right, float bottom, float top, float near, float far)
{
	float temp[4][4] =
	{
