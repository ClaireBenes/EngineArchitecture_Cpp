...
public:
	...
	/**
	 * @brief Called when the component ends.
	 * Unregisters the component from debug rendering and removes it from the physics system.
	 */
	void OnEnd() override;

	/**
	 * @brief Pure virtual method to check collision with another collider component.
	...
	/**
	 * @brief Debug rendering color for the collider (default: red).
	 */
