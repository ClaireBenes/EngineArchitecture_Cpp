...
{
	/**
	 * @brief Minimum corner of the box in 3D space.
	 * Defaults to (-1, -1, -1).
	 */
	Vector3 min = Vector3::One * -1.0f;
	/**
	 * @brief Maximum corner of the box in 3D space.
	 * Defaults to (1, 1, 1).
	 */
	Vector3 max = Vector3::One;

	/**
	 * @brief Calculates the size (width, height, depth) of the box.
	...
	/**
	 * @brief Checks if two AABBs intersect (collide).
