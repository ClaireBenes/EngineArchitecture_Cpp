...
/**
 * @brief Quaternion represents a rotation in 3D space using four components (x, y, z, w).
...
public:
	...
	/**
	 * @brief Default constructor initializes the quaternion to the identity quaternion.
	...
	/**
	 * @brief Constructs a quaternion using four float values representing the components (x, y, z, w).
	...
	/**
	 * @brief Constructs a quaternion from an axis of rotation and an angle in radians.
	...
	/**
	 * @brief Constructs a quaternion from pitch, yaw, and roll (Euler angles).
	...
	/**
	 * @brief Sets the quaternion components explicitly. This method is intended for direct initialization,
	...
	/**
	 * @brief Conjugates the quaternion, flipping the sign of the vector part (x, y, z).
	 */
	void Conjugate();
	/**
	 * @brief Normalizes the quaternion, ensuring it has a unit length (i.e., it represents a valid rotation).
	 * This method alters the current quaternion.
	 */
	void Normalize();

	/**
	 * @brief Computes and returns the squared length of the quaternion.
	 * The squared length is the sum of the squares of the quaternion components.
	 * @return The squared length of the quaternion.
	 */
	float LengthSqr() const;
	/**
	 * @brief Computes and returns the length (magnitude) of the quaternion.
	...
	/**
	 * @brief Computes the pitch (rotation around the X-axis) of the quaternion.
	 * @return The pitch angle in radians.
	 */
	float GetPitch() const;
	/**
	 * @brief Computes the yaw (rotation around the Y-axis) of the quaternion.
	 * @return The yaw angle in radians.
	 */
	float GetYaw() const;
	/**
	 * @brief Computes the roll (rotation around the Z-axis) of the quaternion.
	...
	/**
	 * @brief Returns a normalized version of the given quaternion.
	...
	/**
	 * @brief Concatenates two quaternions (i.e., applies one rotation after the other).
	...
	/**
	 * @brief Creates a quaternion representing the rotation to "look at" a target point.
	...
	/**
	 * @brief Creates a quaternion representing the rotation to "look at" a target point from an origin.
	...
	/**
	 * @brief Converts the quaternion to a 4x4 matrix representation.
	...
	/**
	 * @brief Identity quaternion: represents no rotation (used as a reference for default state).
	 */
