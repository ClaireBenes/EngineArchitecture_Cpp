...
/**
 * @brief Namespace providing mathematical constants and utility functions.
 */
namespace Maths
{
    ...
    /**
     * @brief Checks if a float value is near zero within a small epsilon range.
    ...
    /**
     * @brief Computes the arctangent of y/x using signs to determine the correct quadrant.
    ...
    /**
     * @brief Computes the cotangent of an angle (in radians).
     * @param angle Angle in radians.
