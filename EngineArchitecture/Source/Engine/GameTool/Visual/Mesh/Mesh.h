...
/**
 * @brief Mesh represents a drawable collection of vertices, textures, and shader data.
...
public:
	...
	Mesh();
	/**
	 * @brief Constructs a mesh using a list of vertices.
	...
	/**
	 * @brief Unloads the mesh by deleting the vertex array object.
	 * This frees GPU resources associated with the mesh.
	 */
	void Unload();
	/**
	 * @brief Adds a texture to the mesh. The texture can later be bound during rendering.
	 * @param pTexture Pointer to the texture to add to the mesh.
	 */
	void AddTexture(Texture* pTexture);

	/**
	 * @brief Converts the mesh's vertex data into a flat float array suitable for GPU uploading.
	...
	/**
	 * @brief Retrieves a texture attached to the mesh at a specified index.
	...
	/**
	 * @brief the shader program currently assigned to the mesh.
	 * @return The shader program used by this mesh.
	 */
	ShaderProgram GetShaderProgram();
	/**
	 * @brief the vertex array object used to render the mesh.
	 * @return Pointer to the VertexArray object associated with the mesh.
	 */
	VertexArray* GetVertexArray();

	/**
	 * @brief the shader program to be used by the mesh for rendering.
...
private:
	/**
	 * @brief List of all textures assigned to the mesh
	 */
	std::vector<Texture*> mAllTextures;
	/**
	 * @brief Vertex Array Object representing the mesh geometry
	 */
	...
	/**
	 * @brief Shader program used to render the mesh
	 */
