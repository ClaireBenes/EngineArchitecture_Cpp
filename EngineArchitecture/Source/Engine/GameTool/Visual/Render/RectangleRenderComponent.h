...
/**
 * @brief RectangleRenderComponent is a simple render component for drawing a 2D rectangle.
...
public:
	/**
	 * @brief Renders the rectangle in screen space using the assigned color.
	...
	/**
	 * @brief Returns the rendering category (Viewport) for this rectangle component.
	 * @return RenderType::Viewport
	 */
	RenderType GetRenderType() override;

	/**
	 * @brief The local rectangle definition (position is relative to actor's transform).
	 */
